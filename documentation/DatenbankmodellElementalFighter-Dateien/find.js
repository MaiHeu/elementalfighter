...
var strProps		= "Shape-Daten";
var strResults		= "Suchergebnisse für:";

var strShape	= "Shape-Name:";
var strNoCustomPropertiesToDisplayText = "Drücken Sie CTRL+, während Sie auf ein Shape der Zeichnung klicken, um die Details anzuzeigen.";
	...
	if (searchTokensArray.length > 0)
	{
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(\'results_' + lastPageID + '_' + shapeID + '\',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" style="padding-left:13px" alt="Shape-Details ein-/ausblenden" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
